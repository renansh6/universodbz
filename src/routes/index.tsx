        ...
        <div className="mt-6 grid grid-cols-1 gap-4 text-left sm:grid-cols-2 sm:items-start">
          <div className="flex h-full flex-col rounded-xl border border-border p-4">
            ...
            <a
              ...
              className="cta-glow mt-auto flex w-full items-center justify-center rounded-md bg-primary px-4 pt-4 pb-4 text-center text-sm font-extrabold uppercase leading-tight tracking-wide text-primary-foreground underline underline-offset-4 transition-transform hover:scale-[1.02] sm:text-base"
            >
          ...
          <div className="flex h-full flex-col rounded-xl border-2 border-primary p-4">
            ...
            <a
              ...
              className="mt-auto flex w-full items-center justify-center rounded-md bg-gold px-4 pt-4 pb-4 text-center text-sm font-extrabold uppercase leading-tight tracking-wide text-background underline underline-offset-4 transition-transform hover:scale-[1.02] sm:text-base"
            >
